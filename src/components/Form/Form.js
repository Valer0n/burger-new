  ...
  return (
    <div>
      <form className="modal__input" onSubmit={handleSubmit(props.postOrder)}>
        ...
        <br />
        <p className="error">
          {errors?.name && <p>{errors?.name?.message || "Enter your name!"}</p>}
        </p>
        <input
          type="number"
          name="number"
        ...
        <p className="error">
          {errors?.number && (
            <p>{errors?.number?.message || "Enter your number!"}</p>
          )}
        </p>
        <input
          type="text"
        ...
        <p className="error">
          {errors?.address && (
            <p>{errors?.address?.message || "Enter your address!"}</p>
          )}
        </p>
        <input
          type="checkbox"
        ...
        <input
          ...
          onChange={props.checkPromo}
        />
        <button className="button-order" type="submit" disabled={!isValid}>
          ORDER
        </button>
        <button className="button-close" onClick={props.onShowHideModal}>
          CLOSE
        </button>
      </form>
    </div>
